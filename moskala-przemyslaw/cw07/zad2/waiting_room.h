...
const char accshm[] = "/sh.m";
const char shmpth[] = "/shm.pth";
const char freeseats[] = "/s.eats";
const char customersinqueue[] = "/c.iq";
const char chair[] = "/chai.r";
const char payment[] = "/pa.yment";
